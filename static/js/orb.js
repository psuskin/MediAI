var w = c.width = document.getElementById("orb").offsetWidth,
		h = c.height = document.getElementById("orb").offsetWidth,
		ctx = c.getContext( '2d' ),
...
window.addEventListener( 'resize', function(){
	...
	opts.vanishPoint.x = ( w = c.width = document.getElementById("orb").offsetWidth ) / 2;
	opts.vanishPoint.y = ( h = c.height = document.getElementById("orb").offsetWidth ) / 2;
	ctx.fillRect( 0, 0, w, h );
});
